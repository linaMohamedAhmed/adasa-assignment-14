...
import { Category, PhotographersData, SiteInfo } from '../photographers-data';

@Injectable({
  providedIn: 'root',
})
export class Global {
  photographerList: PhotographersData[] = [
    {
      id: 1,
  ...
  featuredPhotographers = this.photographerList.slice(0, 3);
  // ----------------------- length list ---------------
  lengthPhotographersList = this.photographerList.length;
  featuredPhotographersCardsBlog = this.photographerList.slice(0, 6);

  eventsPhotographers = this.photographerList.slice(3, 6);
